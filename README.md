...
Add 6 photos to `public/images/` named: `1.jpeg` to `6.jpeg`
...
5. Deploy (SPA redirects are already configured with `netlify.toml` and `public/_redirects`)

---

## ��� Issues?

- **Photos not showing?** Check names (`1.jpeg` to `6.jpeg`) and location (`public/images/`)
