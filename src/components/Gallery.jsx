...
function Gallery({ isActive }) {
  ...
  const photos = [
    { src: "/images/2.jpeg", alt: "Memory 1" },
    { src: "/images/3.jpeg", alt: "Memory 2" },
    { src: "/images/6.jpeg", alt: "Memory 3" },
    { src: "/images/1.jpeg", alt: "Memory 4" },
    { src: "/images/5.jpeg", alt: "Memory 5" },
    { src: "/images/4.jpeg", alt: "Memory 6" },
  ];
